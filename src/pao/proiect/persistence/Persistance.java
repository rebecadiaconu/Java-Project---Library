...
public class Persistance {
    ...
    public List<Literar> literarDinFisier(String[] dataFields, String[] dataFieldsRub) {
        List<Literar> carti = new ArrayList<>();
    ...
    public List<Nonliterar> nonliterarDinFisier(String[] dataFields, String[] dataFieldsRub) {
        List<Nonliterar> carti = new ArrayList<>();
    ...
    public List<Rubrica> rubricaDinFisier(String[] dataFields) {
        List<Rubrica> rubrici = new ArrayList<>();
        try (BufferedReader bufferedReaderRub = new BufferedReader(new FileReader("rubrici.csv"))) {
            String currLineRub;
            while ((currLineRub = bufferedReaderRub.readLine()) != null) { String[] dataFieldsRub = currLineRub.split(",");

                if (Integer.parseInt(dataFields[0]) == Integer.parseInt(dataFieldsRub[0])) {
                    List<Carte> carti = new ArrayList<>();
                    List<Literar> lit = literarDinFisier(dataFields, dataFieldsRub);
                    List<Nonliterar> nonlit = nonliterarDinFisier(dataFields, dataFieldsRub);
    ...
    public List<Pair<Carte, Integer>> cartiComandateDinFisier(String[] dataFieldsCom) {
    ...
    public List<Client> clientDinFisier(String[] dataFields) {
                    ...
                    try (BufferedReader bufferedReaderCom = new BufferedReader(new FileReader("comenzi.csv"))) {
                        ...
                        while ((currLineLCom = bufferedReaderCom.readLine()) != null) {
                            ...
                            if (Integer.parseInt(dataFieldsCl[1]) == Integer.parseInt(dataFieldsCom[1]) && Integer.parseInt(dataFieldsCl[0]) == Integer.parseInt(dataFieldsCom[0])) {
                                List<Pair<Carte, Integer>> cartiCump = cartiComandateDinFisier(dataFieldsCom);
    ...
    public List<Librarie> librarieDinFisier() {
        List<Librarie> listObj = new ArrayList<>();
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("librarie.csv"))) {
            ...
            while ((currLine = bufferedReader.readLine()) != null) {
                ...
                List<Rubrica> rubrici = rubricaDinFisier(dataFields);
                List<Client> clienti = clientDinFisier(dataFields);
    ...
    public void scrieCartiComandate(List<Librarie> library) {
    ...
    public void scrieComanda(List<Librarie> library) {
    ...
    public void scrieClient(List<Librarie> library) {
    ...
    public void scrieNonliterar(List<Librarie> library) {
    ...
    public void scrieLiterar(List<Librarie> library) {
    ...
    public void scrieRubrica(List<Librarie> library) {
    ...
    public void scriereLibrarie(List<Librarie> library) {
